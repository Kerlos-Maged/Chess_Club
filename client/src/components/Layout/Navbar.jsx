...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 bg-gradient-to-r from-slate-950 via-blue-950 to-slate-950 text-white shadow-2xl border-b-4 border-blue-700 opacity-90 backdrop-blur-sm h-28">
